...
#define SUNTON_ESP32_BCKL_OFF_LEVEL !LCD_BCKL_ON_LEVEL
#define SUNTON_ESP32_PIN_BCKL        GPIO_NUM_2

#define SUNTON_ESP32_LCD_PIN_HSYNC   GPIO_NUM_39 // HSYNC
#define SUNTON_ESP32_LCD_PIN_VSYNC   GPIO_NUM_41 // VSYNC
#define SUNTON_ESP32_LCD_PIN_DE      GPIO_NUM_40 // DE
#define SUNTON_ESP32_LCD_PIN_PCLK    GPIO_NUM_42 // DCLK
